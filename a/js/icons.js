(function($){
  ...
  function draw_apple_touch_icon(canvas, size) {
    ...
    context.fillText("Propos", 10 * resize_factor, 78 * resize_factor);

    context.fillStyle = "rgba(255, 255, 255, 0.701961)";
    context.font = "normal " + (20.5 * resize_factor) + "px 'adelle-sans'";
    context.fillText("par Pascal", 10 * resize_factor, 103 * resize_factor);
  }
