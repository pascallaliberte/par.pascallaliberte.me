(function($){
  ...
  init_continue_reading_save_offset = function() {
    $("a[href$='#continuer-lecture']").click(function( event ) {
  ...
  $(document).ready(function(){
    ...
    if ("#continuer-lecture" == document.location.hash) {
      ...
      // scroll to just above the continuer-lecture-position
      $.smoothScroll({
        scrollTarget: '#continuer-lecture',
